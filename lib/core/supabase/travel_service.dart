...
abstract final class TravelService {
  ...
  static TravelItem _fromRow(Map<String, dynamic> row, List<String> docIds) {
    ...
    return TravelItem(
      ...
      endTime:                (rawEndTime != null && rawEndTime.length >= 5) ? rawEndTime.substring(0, 5) : rawEndTime,
      ...
      boardingTime:           (rawBoardingTime != null && rawBoardingTime.length >= 5) ? rawBoardingTime.substring(0, 5) : rawBoardingTime,
      linkedDocIds:           docIds,
