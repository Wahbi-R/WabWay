...
class _TripGateState extends State<TripGate> {
  ...
  Future<void> _onTripCreated(String tripId) async {
    await _load();
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (_error) {
      return _ErrorScreen(onRetry: _load);
    }

    if (_trips.isEmpty) {
      return _NoTripsScreen(onTripCreated: _onTripCreated);
    }
...
class _NoTripsScreen extends StatelessWidget {
  const _NoTripsScreen({required this.onTripCreated});
  final Future<void> Function(String tripId) onTripCreated;

  void _showJoinStub(BuildContext context) {
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Joining by code', style: kStyleTitle, textAlign: TextAlign.center),
            const SizedBox(height: kSpace2),
            Text(
              'Invite codes are coming soon. Ask your organiser to send you an invite link when it\'s ready.',
              style: kStyleCaption,
              ...
              child: Column(
                ...
                children: [
                  ...
                  WabwayButton(
                    ...
                    onPressed: () => _showJoinStub(context),
                    fullWidth: true,
                    size: WabwayButtonSize.lg,
