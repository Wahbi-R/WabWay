...
class _AddItemContentState extends State<_AddItemContent> {
  ...
  void _submit() {
    ...
    widget.onSubmit(ItineraryItem(
      ...
      mapsUrl:         _showAdvanced && _mapsCtrl.text.trim().isNotEmpty ? _mapsCtrl.text.trim() : null,
      confirmationUrl: _showAdvanced && _confirmCtrl.text.trim().isNotEmpty ? _confirmCtrl.text.trim() : null,
